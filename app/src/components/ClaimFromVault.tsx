...
export const ClaimFromVault: FC = () => {
    ...
    const onClick = useCallback(async () => {
        ...
        try {
            ...
            console.log("vault input: "+vaultString);
    ...
    return (
        <div className="flex flex-row justify-center">
            ...
            <div className="relative group items-center text-black ">
                <input type="text" id="vaultInput" name="vaultInput" onChange={e => { setVaultString(e.currentTarget.value); console.log("changed", e.currentTarget.value) }}/>
            </div>
            <div className="relative group items-center">
